      ...
      <a href="generate-link.php">
        <div class="card card-chart">
          <div class="card-header">
            ...
            <h4 class="card-title" style="color: #2c2c2c;">Generated Link</h4>
          </div>
      ...
      <a href="status.php">
        <div class="card card-chart">
          <div class="card-header">
            ...
            <h4 class="card-title" style="color: #2c2c2c;">Link Status</h4>
          </div>
          <div class="card-footer">
            <div class="stats">
              <i class="now-ui-icons arrows-1_refresh-69"></i> Just Updated
      ...
      <a href="admobreport.php">
        <div class="card card-chart">
          <div class="card-header">
            ...
            <h4 class="card-title" style="color: #2c2c2c;">Ad Mob Report</h4>
          </div>
          <div class="card-footer">
            <div class="stats">
      ...
      <a href="bankstatus.php">
        <div class="card card-chart">
          <div class="card-header">
            ...
            <h4 class="card-title" style="color: #2c2c2c;">Bank Status</h4>
          </div>
